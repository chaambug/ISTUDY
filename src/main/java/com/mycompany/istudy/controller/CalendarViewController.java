...
public class CalendarViewController extends BaseController{
    ...
    public void refreshCalendar(int month, int year){
        String selectedModul = instance.getModuleListjComboBox().getSelectedItem().toString();
        ...
        if (month == 0 && year <= realYear-10){instance.getPreviousjButton().setEnabled(false);} //Too early
        if (month == 11 && year >= realYear+100){instance.getNextjButton().setEnabled(false);} //Too late
